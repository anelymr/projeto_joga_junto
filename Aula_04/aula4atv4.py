...
anos_cachorro = idade_pet * 7

print(f"Olá, {nome_pet} tem {anos_cachorro} anos de idade.")
...
print(f"Olá, {nome_pet} tem {idade_pet} anos") e nos ultimos 12 meses o lucro com este animal foi de R${}
